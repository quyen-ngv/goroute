...
public class ActivityCommerceRepositoryImpl implements ActivityCommerceRepository {
 ...
 public int insertProduct(MarketplaceActivityProduct v){return m.insertProduct(v);}public int updateProduct(MarketplaceActivityProduct v){return m.updateProduct(v);}public Optional<MarketplaceActivityProduct> findProduct(UUID id){return Optional.ofNullable(m.findProduct(id));}public Optional<MarketplaceActivityProduct> findPublicProduct(UUID id){return Optional.ofNullable(m.findPublicProduct(id));}public List<MarketplaceActivityProduct> findProductsByOrganization(UUID id){return m.findProductsByOrganization(id);}public List<MarketplaceActivityProduct> findProductsPublic(String q,int l,int o){return m.findProductsPublic(q,l,o);}public List<MarketplaceActivityProduct> findProductsAdmin(String q,String s,int l,int o){return m.findProductsAdmin(q,s,l,o);}
 ...
 public int insertOrder(ActivityOrder v){return m.insertOrder(v);}public int insertOrderItem(ActivityOrderItem v){return m.insertOrderItem(v);}public Optional<ActivityOrder> findOrder(UUID id){return Optional.ofNullable(m.findOrder(id));}public Optional<ActivityOrder> findOrderByUserAndIdempotencyKey(UUID userId,String key){return Optional.ofNullable(m.findOrderByUserAndIdempotencyKey(userId,key));}public List<ActivityOrder> findExpiredPendingOrders(LocalDateTime now,int limit){return m.findExpiredPendingOrders(now,limit);}public int expireOrderHold(UUID id,long version,UUID actor,LocalDateTime now){return m.expireOrderHold(id,version,actor,now);}public Optional<ActivityOrderItem> findOrderItem(UUID id){return Optional.ofNullable(m.findOrderItem(id));}public List<ActivityOrder> findOrdersByUser(UUID id,int l,int o){return m.findOrdersByUser(id,l,o);}public List<ActivityOrder> findOrdersByOrganization(UUID id,String s,int l,int o){return m.findOrdersByOrganization(id,s,l,o);}public List<ActivityOrder> findOrdersAdmin(String q,String s,int l,int o){return m.findOrdersAdmin(q,s,l,o);}public int updateOrderStatus(UUID id,long v,String s,UUID a,LocalDateTime n){return m.updateOrderStatus(id,v,s,a,n);}
}
