...
MarketplaceActivityResponse getPublic(UUID id);List<ActivityPackageResponse> listPublicPackages(UUID id);List<ActivitySlotResponse> listPublicSlots(UUID packageId,LocalDateTime from);
 List<MarketplaceActivityResponse> partnerList(UUID actor,UUID organizationId);MarketplaceActivityResponse partnerGet(UUID actor,UUID id);MarketplaceActivityResponse partnerCreate(UUID actor,UpsertMarketplaceActivityRequest request);MarketplaceActivityResponse partnerUpdate(UUID actor,UUID id,UpsertMarketplaceActivityRequest request);
