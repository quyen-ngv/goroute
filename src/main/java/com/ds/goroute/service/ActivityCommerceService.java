...
public interface ActivityCommerceService {
 ...
 List<MarketplaceActivityResponse> adminProducts(String query,String status,int page,int size);MarketplaceActivityResponse adminProductStatus(UUID actor,UUID id,MarketplacePublicationStatus status,String reason,Long expectedVersion);List<ActivityOrderResponse> adminOrders(String query,String status,int page,int size);ActivityOrderResponse adminOrderStatus(UUID actor,UUID id,UpdateActivityOrderStatusRequest request);
