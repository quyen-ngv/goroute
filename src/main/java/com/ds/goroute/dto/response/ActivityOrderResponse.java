...
public class ActivityOrderResponse {
    ...
    private Map<String,Object> contactInfo; private String specialRequests; private String redemptionStatus; private LocalDateTime redeemedAt; private LocalDateTime holdExpiresAt;
